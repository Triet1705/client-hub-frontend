...
export function RoleBadge({ role }: RoleBadgeProps) {
  ...
  switch (role) {
    ...
    case "CLIENT":
      return <span className="px-2.5 py-1 rounded-full text-[10px] font-bold tracking-wider bg-blue-500/10 text-blue-400 uppercase ring-1 ring-blue-500/30">CLIENT</span>;
    case "FREELANCER":
